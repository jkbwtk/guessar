<div class="auth-box" id="authBox">
  ...
  <form class="auth-form" id="authForm">
    <div class="auth-field-group">
      ...
      <input class="auth-input" type="text" id="authUsername" name="username" minlength="3" maxlength="32" pattern="[a-zA-Z0-9!@#$%^&*()\-+<>?:;&quot;&#39;\[\]{}`~=_\+/,\.]+" placeholder="Username" autocomplete="username" required>
      ...
      <div class="auth-password-group">
        <img class="auth-show-password" src="/public/img/eyeIcon.svg">
        <input class="auth-input" type="password" id="authConfirmPassword" name="password" minlength="8" maxlength="64" pattern="[a-zA-Z0-9!@#$%^&*()\-+<>?:;&quot;&#39;\[\]{}`~=_\+/,\.]+" placeholder="Repeat Password" required>
      </div>
    </div>

    <button class="button-small auth-submit-button" id="authSubmit" type="submit">Sign Up</button>
  </form>
  ...
  <div class="auth-option-group">
    ...
    <div class="auth-option">
      ...
      <a id="authSwitchLogin" href="/login">Log In</a>
    </div>
  </div>
</div>